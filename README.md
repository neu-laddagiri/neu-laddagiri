...
🌐 **[lokeshaddagiri.com](https://lokeshaddagiri.com)** for my portfolio, full coursework archive, and project write-ups
...
A privacy-first Instagram export analyzer. Your ZIP is parsed locally in the browser, so nothing uploads. It builds a unified social graph, scores relationship strength and privacy exposure, and renders day-by-hour activity heatmaps.
...
Pulled roughly 35,000 consumer complaints through the CFPB API to test whether federal enforcement actions actually change bank behavior. Four-person capstone, and my first end-to-end data science pipeline.
